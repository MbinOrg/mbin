...
final class Version20260603205601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE instance_block (id INT NOT NULL, user_id INT NOT NULL, instance_id INT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_8F85864AA76ED395 ON instance_block (user_id)');
        $this->addSql('CREATE INDEX IDX_8F85864A3A51721D ON instance_block (instance_id)');
        $this->addSql('CREATE UNIQUE INDEX instance_block_idx ON instance_block (user_id, instance_id)');
