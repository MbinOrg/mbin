...
class ImageProcessingCommand extends Command
{
    ...
    {
        $this
            ->addArgument('type', InputArgument::REQUIRED, 'Type of images to delete either posts or users (default posts).', 'posts')
            ->addArgument('monthsAgo', InputArgument::REQUIRED, 'Delete images older than x months (default 3 months).', 3)
