...
class EntriesTrashApi extends EntriesBaseApi
{
    ...
    public function trash(
        ...
        $response = $this->serializeEntry($factory->createDto($entry), $this->tagLinkRepository->getTagsOfContent($entry));
    ...
    public function restore(
        ...
        return new JsonResponse(
            $this->serializeEntry($factory->createDto($entry), $this->tagLinkRepository->getTagsOfContent($entry)),
            headers: $headers
        );
    }
}
