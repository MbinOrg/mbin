...
class OAuth2UserConsent
{
    ...
    public const SCOPE_DESCRIPTIONS = [
        ...
        'user:bookmark' => 'oauth2.grant.user.bookmark',
        'user:bookmark:add' => 'oauth2.grant.user.bookmark.add',
        'user:bookmark:remove' => 'oauth2.grant.user.bookmark.remove',
        'user:bookmark_list' => 'oauth2.grant.user.bookmark_list',
        'user:bookmark_list:read' => 'oauth2.grant.user.bookmark_list.read',
        'user:bookmark_list:edit' => 'oauth2.grant.user.bookmark_list.edit',
        'user:bookmark_list:delete' => 'oauth2.grant.user.bookmark_list.delete',
