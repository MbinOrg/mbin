...
class EntriesRetrieveApi extends EntriesBaseApi
{
    ...
    public function __invoke(
        ...
        return new JsonResponse(
            $this->serializeEntry($dto, $this->tagLinkRepository->getTagsOfContent($entry)),
            headers: $headers
        );
    }
    ...
    public function collection(
        ...
        foreach ($entries->getCurrentPageResults() as $value) {
            try {
                ...
                array_push($dtos, $this->serializeEntry($factory->createDto($value), $this->tagLinkRepository->getTagsOfContent($value)));
