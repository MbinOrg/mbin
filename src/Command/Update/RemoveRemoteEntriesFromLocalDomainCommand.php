...
class RemoveRemoteEntriesFromLocalDomainCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $stmt1->bindValue('dId', $domain->getId());
        ...
        $stmt2->bindValue('dId', $domain->getId());
        ...
        $stmt3->bindValue('dId', $domain->getId());
        ...
        $stmt4->bindValue('c', $countAfter);
        $stmt4->bindValue('dId', $domain->getId());
