...
And now change: `redirect_response_code: 302` to: `redirect_response_code: 301`. If you are experience image issues, validate your Nginx configuration or set it back to `302`.
