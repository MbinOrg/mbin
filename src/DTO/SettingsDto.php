...
class SettingsDto implements \JsonSerializable
{
    public function __construct(
        ...
        public bool $KBIN_PRIVATE_INSTANCE,
    ...
    public function mergeIntoDto(SettingsDto $dto): SettingsDto
    {
        ...
        $dto->KBIN_PRIVATE_INSTANCE = $this->KBIN_PRIVATE_INSTANCE ?? $dto->KBIN_PRIVATE_INSTANCE;
    ...
    public function jsonSerialize(): mixed
    {
        return [
            ...
            'KBIN_PRIVATE_INSTANCE' => $this->KBIN_PRIVATE_INSTANCE,
