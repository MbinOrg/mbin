...
final class Version20231121010453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX magazine_ap_id_idx ON magazine (lower(ap_id))');
        $this->addSql('CREATE INDEX magazine_ap_profile_id_idx ON magazine (lower(ap_profile_id))');
        $this->addSql('CREATE INDEX user_ap_id_idx ON "user" (lower(ap_id))');
        $this->addSql('CREATE INDEX user_ap_profile_id_idx ON "user" (lower(ap_profile_id))');
        ...
        $this->addSql('CREATE INDEX entry_ap_id_idx ON entry (lower(ap_id))');
        $this->addSql('CREATE INDEX entry_comment_ap_id_idx ON entry_comment (lower(ap_id))');
        $this->addSql('CREATE INDEX post_ap_id_idx ON post (lower(ap_id))');
        $this->addSql('CREATE INDEX post_comment_ap_id_idx ON post_comment (lower(ap_id))');
    }
