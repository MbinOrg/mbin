...
```ini
[program:messenger]
command=php /var/www/mbin/bin/console messenger:consume scheduler_default old async async_ap outbox deliver inbox receive resolve failed --time-limit=3600
user=www-data
numprocs=4
startsecs=0
autostart=true
